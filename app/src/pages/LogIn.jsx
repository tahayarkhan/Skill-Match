...
import { loginVolunteer, loginEmployer } from '../services/api'; // Ensure these API functions are defined
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (formData.userType === 'volunteer') {
                response = await loginVolunteer(formData); // API call for volunteer login
            } else {
                response = await loginEmployer(formData); // API call for employer login
            }
            ...
            if (response) {
                ...
                if (formData.userType === 'employer') {
                    navigate('/employer-home'); // Redirect to employer homepage
                } else {
